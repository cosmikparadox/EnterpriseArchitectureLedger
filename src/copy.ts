...
export const copy = {
  ...
  next_intent_1: 'If the testing holds, the intent is an open source release. Any organisation could take it and review it against its own security standards first.',
  next_intent_2: "It would run inside that organisation's own secure environment, on its own telemetry. Nothing would be sent outside.",
  next_intent_3: 'So far it has only run on invented data and a little dated public telemetry. Real data from real organisations will show where it breaks, and where it earns its keep.',
  next_intent_4: 'It is meant for architects, finance teams, and anyone who has had to defend a number about their systems.',
  ...
  snip_hint: 'Tap any platform or line to cut it and see what it strands.',
  snip_node: 'Cutting {name} strands {n} use cases. Moving them is about USD {exec} of work.',
  snip_link: 'Cutting this line strands {uc}. It cannot run without {platform}.',
  snip_again: 'Tap another to cut that instead, or the background to put everything back.',
  badge_exit_head: '{name}, the work of leaving',
  badge_exit_line: 'about USD {exec}',
  badge_exit_sub: 'Month {m}: {n} of {all} use cases attached.',
  badge_exit_after: 'All have attached. From here only time adds to it.',
